...
- 💭 **连续追问**：深入讨论某个话题
- 🧹 **历史管理**：查看和清除对话历史
- 📊 **轮数控制**：灵活控制保留的历史轮数（1-50+轮可调），避免 Token 消耗过大

💡 **推荐配置**：快速问答 1-5轮 | 一般对话 5-10轮 | 深度讨论 20-30轮 | 长期对话 50+轮

详细配置方法见：[使用指南 - 历史轮数控制](USER_GUIDE.md#历史轮数控制)
...
- 🎨 **图形化界面**：美观易用，零学习成本
- 💬 **对话界面**：聊天式交互体验
- 📝 **Markdown 渲染**：LLM 输出自动渲染为 Markdown 格式，支持代码高亮、表格、列表等 ⭐
- 🔧 **参数调节**：可视化调整检索参数
- 📊 **实时反馈**：进度提示、状态显示
- 📌 **来源追溯**：显示参考文档和相似度
