...
- Python 3.8+
- LLM API Key (OpenAI/DeepSeek/Qwen 等)
...
1. **初始化系统** - 切换到「⚙️ 系统设置」，点击「初始化系统」
2. **注册数据源** - 在「🗄️ 数据源管理」中添加数据库或文件
3. **开始分析** - 在「💬 对话分析」中用自然语言提问
...
2. 填写信息：
   - 数据源名称：`my_db`
   - 数据库路径：`data/databases/example.db`
3. 点击「✅ 注册数据库」
